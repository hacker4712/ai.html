...
<head>
    ...
    <title>Confidently Wrong · AI Fact-Check Lab</title>
    <meta name="description" content="Class 12 science exhibition — fact-check AI claims with real-world sources." />
    ...
    <style>
        ...
        * {
        ...
        .terminal .tag { color: var(--gold); font-weight: 600; margin-right: 0.5rem; }
        .terminal .qline { color: var(--text-secondary); margin-bottom: 0.8rem; }
        .terminal .aline { color: var(--text-primary); margin-bottom: 1rem; min-height: 1.65em; white-space: pre-wrap; }
        .typecursor {
            display: inline-block;
            width: 0.5em;
            height: 1.2em;
        ...
        .flag .flag-icon svg { width: 1rem; height: 1rem; color: var(--accent); }
        .flag-title { font-family: var(--font-mono); font-size: 0.6rem; letter-spacing: 0.1em; color: var(--accent); font-weight: 600; }
        .flag-body { font-size: 0.82rem; color: var(--text-secondary); line-height: 1.5; }
        ...
        .confidence .label b { color: var(--accent); font-weight: 600; }
        .confidence .track {
            height: 5px;
        ...
        .lab-input-wrap input::placeholder { color: var(--text-muted); }
        ...
        .lab-input-wrap button:hover::before {
            transform: translateX(100%);
        }
        ...
        .lab-input-wrap button:active { transform: scale(0.96); }
        ...
        /* ── X-Ray Claims with REAL SOURCES ── */
        .xray-claims {
            display: flex;
        ...
        .xray-claim:nth-child(4) { animation-delay: 0.26s; }
        @keyframes slideIn {
        ...
        .xray-claim .source-link .link-icon { font-size: 0.65rem; }
        .sources-label {
            font-family: var(--font-mono);
            font-size: 0.55rem;
            color: var(--text-muted);
        ...
        .lab-loading .loader-text {
            color: var(--gold);
            font-family: var(--font-mono);
            font-size: 0.7rem;
            letter-spacing: 0.08em;
        }
        .lab-loading .loader-dots::after {
            content: '';
        ...
        .challenge-card .options button:disabled { opacity: 0.4; cursor: default; }
        ...
        .reveal-answer.show { display: block; }
        .reveal-answer .label {
            font-family: var(--font-mono);
            font-size: 0.6rem;
            color: var(--green);
        ...
        .case-card h3 { font-family: var(--font-display); font-size: 1.1rem; font-weight: 600; margin-bottom: 0.4rem; }
        .case-card p { font-size: 0.85rem; color: var(--text-secondary); line-height: 1.6; }
        .case-card .stat {
            border-top: 1px solid var(--border);
            margin-top: 1rem;
            padding-top: 1rem;
        ...
        .case-card .stat .num { font-family: var(--font-display); font-size: 1.1rem; font-weight: 700; color: var(--gold); }
        .case-card .stat .sub { font-size: 0.7rem; color: var(--text-muted); }
        ...
        @media (max-width: 820px) { .flow-row { grid-template-columns: 1fr; } }
        .flow-step {
            background: rgba(255, 255, 255, 0.02);
            border: 1px solid var(--border);
            border-radius: var(--radius);
        ...
        .flow-step h4 { font-family: var(--font-display); font-size: 1rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.3rem; }
        ...
        footer p { font-size: 0.85rem; color: var(--text-secondary); max-width: 32rem; }
        footer ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.3rem; }
        footer ul li { font-size: 0.78rem; color: var(--text-muted); transition: color 0.3s ease; }
        footer ul li:hover { color: var(--text-secondary); }
        footer .credit {
            margin-top: 2rem;
            padding-top: 1.2rem;
            border-top: 1px solid var(--border);
...
<body>
    ...
    <!-- ════════════════════════════════════════════════ -->
    <!-- LAB PAGE (WITH REAL-WORLD SOURCES) -->
    <!-- ════════════════════════════════════════════════ -->
    <section id="page-lab">
        <div class="wrap">
            <span class="eyebrow">Interactive Lab</span>
            <h2>AI Hallucination Lab</h2>
            <p class="lede">Ask any question, see the AI's answer, then X‑ray it to see which claims are true, need context, or are completely fabricated.</p>
            ...
            <div style="margin-top:2rem;padding:1.2rem 1.5rem;background:rgba(255,255,255,0.015);border-radius:var(--radius);border:1px solid var(--border);">
                ...
                <div class="dashboard-grid">
                    <div class="stat-card">
                        <div class="num" id="dash-questions">0</div>
                        <div class="label">Questions Tested</div>
                    </div>
                    <div class="stat-card">
                        <div class="num" id="dash-claims">0</div>
                        <div class="label">Claims Examined</div>
                    </div>
                    <div class="stat-card">
                        <div class="num" id="dash-unsupported">0</div>
                        <div class="label">Unsupported Claims</div>
                    </div>
                    <div class="stat-card">
                        <div class="num" id="dash-error">0%</div>
    ...
    <section id="page-challenge" style="background:rgba(255,255,255,0.01);border-top:1px solid var(--border);border-bottom:1px solid var(--border);">
        <div class="wrap">
            ...
            <p class="lede">Read the AI's detailed answer, then decide if it's TRUE or FALSE. The AI may be confidently wrong!</p>
    ...
    <section id="page-team" style="background:rgba(255,255,255,0.01);border-top:1px solid var(--border);">
        <div class="wrap">
            ...
            <div class="team-grid">
                ...
                <div class="team-card">
                    <div class="icon-wrap">🔍</div>
                    <div class="member-name">Shreyash Sachaan</div>
                ...
                <div class="team-card">
                    <div class="icon-wrap">📋</div>
                    <div class="member-name">Nimish Mishra</div>
    ...
    <script>
        (function() {
            ...
            // ─── REAL-WORLD ACCESSIBLE SOURCES ───
            const realSources = {
                'edison invented light bulb': [
                    { title: 'US Patent 223,898 - Thomas Edison (1880)', url: 'https://patents.google.com/patent/US223898A/en' },
                    { title: 'Smithsonian Institution - Edison\'s Light Bulb', url: 'https://www.si.edu/object/thomas-edisons-light-bulb' },
                    { title: 'Library of Congress - Edison Papers', url: 'https://www.loc.gov/collections/thomas-edison-papers/' }
                ],
                'shark bones': [
                    ...
                    { title: 'Australian Museum - Shark Biology', url: 'https://australian.museum/learn/animals/fishes/sharks/' }
                ],
                'einstein failed math': [
                    ...
                    { title: 'Scientific American - Einstein Myths', url: 'https://www.scientificamerican.com/article/einstein-failed-math-myth/' }
                ],
                'mount everest': [
                    ...
                    { title: 'Nepal Tourism Board - Everest', url: 'https://www.welcomenepal.com/places-to-see/mount-everest.html' }
                ],
                'capital of australia': [
                    ...
                    { title: 'Parliament of Australia - Canberra History', url: 'https://www.aph.gov.au/About_Parliament/Parliamentary_Departments/Parliamentary_Library/parliamentary_handbook/Canberra' },
                    { title: 'Visit Canberra - Official Tourism', url: 'https://visitcanberra.com.au/' }
                ],
                'great wall visible from space': [
                    ...
                    { title: 'National Geographic - Great Wall Myth', url: 'https://www.nationalgeographic.com/travel/article/see-great-wall-of-china-from-space' },
                    { title: 'BBC - Great Wall Space Myth', url: 'https://www.bbc.com/news/magazine-19190570' }
                ],
                'brain 10 percent': [
                    { title: 'Scientific American - 10% Brain Myth', url: 'https://www.scientificamerican.com/article/do-we-really-use-only-10-percent-of-our-brain/' },
                    { title: 'Psychology Today - Brain Myth Debunked', url: 'https://www.psychologytoday.com/us/blog/the-fallible-mind/201712/the-10-brain-myth' },
                    { title: 'Mayo Clinic - Brain Function', url: 'https://www.mayoclinic.org/healthy-lifestyle/consumer-health/expert-answers/brain/faq-20058384' }
                ],
                'bulls red': [
                    { title: 'Live Science - Bulls and Red', url: 'https://www.livescience.com/33260-are-bulls-angered-by-red-color.html' },
                    { title: 'Scientific American - Bull Myth', url: 'https://www.scientificamerican.com/article/fact-or-fiction-bulls-hate-red/' },
                    { title: 'National Geographic - Bullfighting', url: 'https://www.nationalgeographic.com/animals/article/bullfighting-spain' }
                ],
                'napoleon short': [
                    ...
                    { title: 'Smithsonian Magazine - Napoleon\'s Height', url: 'https://www.smithsonianmag.com/smart-news/napoleon-wasnt-short-after-all-180957693/' }
                ],
                'vikings horned helmets': [
                    { title: 'History.com - Viking Helmets', url: 'https://www.history.com/news/did-vikings-really-wear-horned-helmets' },
                    { title: 'Smithsonian Magazine - Viking Helmet Myth', url: 'https://www.smithsonianmag.com/smart-news/the-myth-of-the-viking-horned-helmet-180951817/' },
                    { title: 'BBC - Viking Facts', url: 'https://www.bbc.co.uk/history/ancient/vikings/weapons_01.shtml' }
                ],
                'water boils 100': [
                    ...
                    { title: 'Encyclopedia Britannica - Boiling Point', url: 'https://www.britannica.com/science/boiling-point' }
                ]
            };

            function getRealSources(claimText) {
                const lowerClaim = claimText.toLowerCase();
                for (const [key, sources] of Object.entries(realSources)) {
                    if (lowerClaim.includes(key) || key.includes(lowerClaim) || 
                        lowerClaim.split(' ').some(word => key.includes(word) && word.length > 3)) {
                        return sources;
                    }
                }
                // Default real-world sources
                return [
                    { title: 'Google Search - Find More Information', url: 'https://www.google.com/search?q=' + encodeURIComponent(claimText) },
                    { title: 'Snopes - Fact Check', url: 'https://www.snopes.com/fact-check/' },
                    { title: 'Wikipedia - General Reference', url: 'https://en.wikipedia.org/wiki/Main_Page' }
                ];
            }
            ...
            // ─── Show loading animation in lab ───
            function showLabLoading() {
                const labA = document.getElementById('lab-a');
                labA.innerHTML = `
                    <div class="lab-loading">
                        <div class="loader"></div>
                        <div class="loader-text">AI is thinking<span class="loader-dots"></span></div>
                    </div>
                `;
            }
            ...
            xrayBtn.addEventListener('click', async function() {
                ...
                try {
                    ...
                    claims.forEach(c => {
                        ...
                        label.textContent = '📚 Real-World Sources:';
                        sourcesDiv.appendChild(label);

                        const sources = getRealSources(c.text);
            ...
            async function generateChallenge() {
                ...
                try {
                    ...
                    if (!data.question || !data.ai_answer || !data.correct_answer || !data.explanation) {
                        throw new Error('Invalid challenge data received');
                    }
                    
                    renderChallenge(data);
                    showMessage('✅ Challenge ready! Read the AI\'s answer carefully.', 'success');
                } catch (err) {
                    console.error('Challenge error:', err);
                    const fallback = getFallbackChallenge();
                    renderChallenge(fallback);
                    showMessage('⚠️ Using fallback challenge. The AI is learning!', 'error');
                }
            }
                ...
                const fallbacks = [
                    {
                        ...
                        ai_answer: "Yes, it's the only man-made structure visible from space with the naked eye.",
            ...
            function renderChallenge(data) {
                ...
                const correctText = data.correct_answer || 'True';
                const isCorrectTrue = correctText.toLowerCase().includes('true') || 
                                     correctText.toLowerCase().includes('yes');

                card.innerHTML = `
                    <span class="status pending">🤖 CHALLENGE</span>
                    <div class="challenge-question-text">${data.question || 'No question available'}</div>
                    <div class="challenge-ai-answer">
                        <span class="ai-label">🤖 AI Says:</span>
                        <div class="ai-text" id="challenge-ai-text">${data.ai_answer || 'No answer available'}</div>
                    </div>
                    <div class="challenge-guess-label">❓ Is the AI correct? Make your guess:</div>
                    <div class="options">
                    ...
                    <div class="reveal-answer">
                        ...
                        <p style="font-weight:bold;color:var(--green);">${correctText}</p>
                ...
                // Type out the AI answer with a typing effect
                const aiTextEl = document.getElementById('challenge-ai-text');
                if (aiTextEl) {
                    const fullText = data.ai_answer || 'No answer available';
                    aiTextEl.textContent = '';
                    let i = 0;
                    
                    function typeStep() {
                        if (i <= fullText.length) {
                            aiTextEl.textContent = fullText.slice(0, i);
                            i++;
